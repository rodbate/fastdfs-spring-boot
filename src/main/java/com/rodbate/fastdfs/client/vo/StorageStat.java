...
public class StorageStat {
    ...
    public long getLastSourceUpdate() {
        return lastSourceUpdate;
    }

    public void setLastSourceUpdate(long lastSourceUpdate) {
        this.lastSourceUpdate = lastSourceUpdate;
    }

    public long getLastSyncUpdate() {
        return lastSyncUpdate;
    }

    public void setLastSyncUpdate(long lastSyncUpdate) {
